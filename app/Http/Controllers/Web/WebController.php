...
class WebController extends Controller
{
    ...
    public function home()
    {
        ...
        $latest_adverstisment = Advertis::orderBy('id', 'desc')->where('status', 'Active')->take(4)->get();
        ...
        return view('web-views.home',
                    compact('featured_products', 'topRated', 'bestSellProduct', 'latest_products', 'categories', 'brands', 'deal_of_the_day', 'top_sellers', 'home_categories', 'brand_setting','latest_adverstisment')
                );
    }
