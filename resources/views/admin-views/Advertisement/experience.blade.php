...
@section('title', \App\CPU\translate('add_experience'))
    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">{{\App\CPU\translate('add_experience')}}</li>
            </ol>
        </nav>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        {{ \App\CPU\translate('add_experience')}}
                    </div>
                    <div class="card-body" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                        <form action="{{route('admin.AddExperience')}}" method="POST">
                            @csrf
                                ...
                                <div class="col-12 col-md-5">
                                    @foreach(json_decode($language) as $lang)
                                        <div class="form-group {{$lang != $default_lang ? 'd-none':''}} lang_form"
                                            ...
                                            <input type="text" name="experiences_level[]" class="form-control"
                                                   placeholder=" {{ \App\CPU\translate('add_experience')}}" {{$lang == $default_lang? 'required':''}}>
                                        </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($experience as $experiences)
                                        <tr>
                                            ...
                                            <td>{{ $experiences->experiences_level }}</td>
                                            <td class="d-flex">
                                                <a class="btn btn-primary btn-sm edit" style="cursor: pointer;"
                                                    title="{{ \App\CPU\translate('Edit')}}"
                                                   href="{{route('admin.EditExperience',[$experiences['id']])}}">
                                                    <i class="tio-edit"></i>
                                                </a>
        ...
        $(document).on('click', '.delete', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{route('admin.deleteExperience')}}",
                        method: 'delete',
                        data: {id: id},
                        success: function () {
