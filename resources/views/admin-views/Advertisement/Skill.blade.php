...
@section('title', \App\CPU\translate('add_skill'))
    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">{{\App\CPU\translate('add_skill')}}</li>
            </ol>
        </nav>
                                    ...
                                    @foreach(json_decode($language) as $lang)
                                        <div class="form-group {{$lang != $default_lang ? 'd-none':''}} lang_form"
                                            ...
                                            <input type="text" name="name[]" class="form-control"
                                                   placeholder="   {{ \App\CPU\translate('add_skill')}}" {{$lang == $default_lang? 'required':''}}>
                                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex">
                                                <a class="btn btn-primary btn-sm edit" style="cursor: pointer;"
                                                   ...
                                                   href="{{route('admin.EditSkill',[$Skills['id']])}}">
                                                    <i class="tio-edit"></i>
                                                </a>
