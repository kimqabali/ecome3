...
@section('title', \App\CPU\translate('add_work_day'))
    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">{{\App\CPU\translate('add_work_day')}}</li>
            </ol>
        </nav>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        {{ \App\CPU\translate('add_work_day')}}
                    </div>
                    <div class="card-body" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                        <form action="{{route('admin.AddWorkDay')}}" method="POST">
                            @csrf
                                    ...
                                    @foreach(json_decode($language) as $lang)
                                        <div class="form-group {{$lang != $default_lang ? 'd-none':''}} lang_form"
                                            ...
                                            <input type="number" name="workDays[]" class="form-control"
                                                   placeholder="{{\App\CPU\translate('enter_work_day')}}" {{$lang == $default_lang? 'required':''}}>
                                        </div>
                            ...
                            <table id="dataTable" class="table table-bordered" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($workDays as $workDay)
                                        <tr>
                                            {{-- <td>{{ $workDay->id }}</td> --}}
                                            <td>{{ $workDay->workDays }}</td>
                                            <td class="d-flex">
                                                <a class="btn btn-primary btn-sm edit" style="cursor: pointer;"
                                                    title="{{ \App\CPU\translate('Edit')}}"
                                                   href="{{route('admin.EditworkDay',[$workDay['id']])}}">
                                                    <i class="tio-edit"></i>
                                                </a>
