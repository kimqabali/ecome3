<div class="sidebarR col-lg-3 col-md-3 pr-lg-3 pr-xl-4">
    ...
    <div class="__customer-sidebar" id="shop-sidebar">
        ...
        <div>
            <!-- Filter by price-->
            <div class="widget-title">
                <a class="{{(Request::is('AddAdvertisement*') || Request::is('AddAdvertisement*'))?'active-menu':''}}"
                href="{{ route('AddAdvertisement') }}">{{\App\CPU\translate('add_advertisment')}}</a></h3>
            </div>
        </div>
        <div>
            <!-- Filter by price-->
            <div class="widget-title">
                <a class="{{(Request::is('disblayAdvertisement*') || Request::is('disblayAdvertisement*'))?'active-menu':''}}"
                href="{{ route('MyAdvertisment') }}">{{\App\CPU\translate('My advertisment')}}</a></h3>
            </div>
        </div>
        <div>
            <!-- Filter by price-->
