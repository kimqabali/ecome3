            ...
            <div class="navbar-vertical-footer-offset pb-0">
                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        {{-- Advertis --}}
                    <li class="nav-item {{(Request::is('admin/Advertisement/*') )?'scroll-here':''}}">
                        <small class="nav-subtitle" title="">{{\App\CPU\translate('advertisements_')}}</small>
                        <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                    </li>
                    <li class="navbar-vertical-aside-has-menu {{Request::is('admin/Advertisement/*')? 'active':''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                           href="javascript:">
                            <i class="tio-star nav-icon"></i>
                            <span
                                class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate"> {{\App\CPU\translate('advertisements_data')}}</span>
                        </a>
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                            style="display: {{Request::is('admin/Advertisement/*')?'block':'none'}}">
                            <li class="nav-item {{Request::is('admin/Advertisement/careerSector*')?'active':''}}">
                                <a class="nav-link " href="{{ route('admin.careerSector') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">  {{ \App\CPU\translate('carrer_sector')}} </span>
                                </a>
                            </li>

                            <li class="nav-item {{Request::is('admin/Advertisement/jobTitle*')?'active':''}}">
                                <a class="nav-link " href="{{ route('admin.jobTitle') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">  {{ \App\CPU\translate('Add_job_title')}}</span>
                                </a>
                            </li>

                            <li class="nav-item {{Request::is('admin/Advertisement/advertiseType*')?'active':''}}">
                                <a class="nav-link " href="{{ route('admin.advertiseType') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">  {{ \App\CPU\translate('add_advertise_type')}}</span>
                                </a>
                            </li>

                            <li class="nav-item {{Request::is('admin/Advertisement/typeContract*')?'active':''}}">
                                <a class="nav-link " href="{{ route('admin.typeContract') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">  {{\App\CPU\translate('add_contract_type')}}</span>
                                </a>
                            </li>

                            <li class="nav-item {{Request::is('admin/Advertisement/workDay*')?'active':''}}">
                                <a class="nav-link " href="{{ route('admin.workDay') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">  {{ \App\CPU\translate('add_work_day')}}  </span>
                                </a>
                            </li>

                            <li class="nav-item {{Request::is('admin/Advertisement/typeWorkHour*')?'active':''}}">
                                <a class="nav-link " href="{{ route('admin.typeWorkHour') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">  {{ \App\CPU\translate('add_work_hour')}} </span>
                                </a>
                            </li>

                            <li class="nav-item {{Request::is('admin/Advertisement/salary*')?'active':''}}">
                                <a class="nav-link " href="{{ route('admin.salary') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">   {{ \App\CPU\translate('add_salary')}}  </span>
                                </a>
                            </li>

                            <li class="nav-item {{Request::is('admin/Advertisement/ExtraBenefit*')?'active':''}}">
                                <a class="nav-link " href="{{ route('admin.ExtraBenefit') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">  {{ \App\CPU\translate('add_extra_benefit')}}  </span>
                                </a>
                            </li>

                            <li class="nav-item {{Request::is('admin/Advertisement/EducationDegree*')?'active':''}}">
                                <a class="nav-link " href="{{ route('admin.EducationDegree') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">  {{ \App\CPU\translate('add_education_degree')}} </span>
                                </a>
                            </li>


                            <li class="nav-item {{Request::is('admin/Advertisement/Experience*')?'active':''}}">
                                <a class="nav-link " href="{{ route('admin.Experience') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">  {{ \App\CPU\translate('add_experience')}} </span>
                                </a>
                            </li>

                            <li class="nav-item {{Request::is('admin/Advertisement/License*')?'active':''}}">
                                <a class="nav-link " href="{{ route('admin.License') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">  {{ \App\CPU\translate('add_license')}} </span>
                                </a>
                            </li>

                            <li class="nav-item {{Request::is('admin/Advertisement/Language*')?'active':''}}">
                                <a class="nav-link " href="{{ route('admin.Language') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate"> {{ \App\CPU\translate('add_language')}}  </span>
                                </a>
                            </li>

                            <li class="nav-item {{Request::is('admin/Advertisement/Nationality*')?'active':''}}">
                                <a class="nav-link " href="{{ route('admin.Nationality') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate"> {{ \App\CPU\translate('add_nationality')}}   </span>
                                </a>
                            </li>

                            <li class="nav-item {{Request::is('admin/Advertisement/Skill*')?'active':''}}">
                                <a class="nav-link " href="{{ route('admin.Skill') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate"> {{ \App\CPU\translate('add_skill')}}   </span>
                                </a>
                            </li>

                            <li class="nav-item {{Request::is('admin/Advertisement/stateAdvertis*')?'active':''}}">
                                <a class="nav-link " href="{{ route('admin.stateAdvertis') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate"> {{ \App\CPU\translate('add_state')}}    </span>
                                </a>
                            </li>

                            <li class="nav-item {{Request::is('admin/Advertisement/CityAdvertis*')?'active':''}}">
                                <a class="nav-link " href="{{ route('admin.CityAdvertis') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">{{ \App\CPU\translate('add_governorate')}}    </span>
                                </a>
                            </li>
                            <li class="nav-item {{Request::is('admin/Advertisement/governorate*')?'active':''}}">
                                <a class="nav-link " href="{{ route('admin.governorate') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate"> {{ \App\CPU\translate('add_Neighborhood')}}    </span>
                                </a>
                            </li>

                        </ul>
                    </li>
                    <li class="navbar-vertical-aside-has-menu {{Request::is('admin/AddAdvertisement*')||Request::is('admin/desblayAdvertisement*')? 'active':''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                           href="javascript:">
                            <i class="tio-star nav-icon"></i>
                            <span
                                class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate"> {{\App\CPU\translate('admin_advertisment')}}</span>
                        </a>
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                        style="display: {{Request::is('admin/AddAdvertisement*')||Request::is('admin/desblayAdvertisement*')?'block':'none'}}">
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/AddAdvertisement*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('admin.AddAdvertisement') }}">
                                    <i class="tio-photo-square-outlined nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate"> {{ \App\CPU\translate('add_advertisment_admin')}}</span>
                                </a>
                            </li>

                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/desblayAdvertisement') || Request::is('admin/desblayAdvertisement/*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('admin.desblayAdvertisement') }}">
                                    <i class="tio-photo-square-outlined nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate"> {{ \App\CPU\translate('show_advertisment_admin')}}</span>
                                </a>
                            </li>

                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/desblayAdvertisementCustomer') || Request::is('admin/desblayAdvertisementCustomer/*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('admin.desblayAdvertisementCustomer') }}">
                                    <i class="tio-photo-square-outlined nav-icon"></i>
                                    <span
