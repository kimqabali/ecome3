                    ...
                    <ul class="navbar-nav" style="{{Session::get('direction') === "rtl" ? 'padding-right: 0px' : ''}}">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link dropdown-toggle" href="#"
                               ...
                               data-toggle="dropdown" > {{ \App\CPU\translate('jobs') }}</a>
                              
                                    <div class="dropdown-menu __dropdown-menu-3 __min-w-165px" aria-labelledby="dropdownMenuButton"
                                            style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                                    <a class="dropdown-item" href="{{route('AddAdvertisement')}}">
                                        {{ \App\CPU\translate('add_job')}}
                                    </a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="{{route('disblayAdvertisement')}}">
                                        {{ \App\CPU\translate('show_job')}}
                                    </a>
                                </div>
                            </div>
                        </li>
                        ...
                        @if ($business_mode == 'multi')
                            ...
                            <span class="count-value px-2"></span>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu __dropdown-menu-3 __min-w-165px" aria-labelledby="dropdownMenuButton"
                                            ...
                                            <a class="dropdown-item" href="{{route('shop.apply')}}">
                                                {{ \App\CPU\translate('become a seller')}}
                                            </a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="{{route('seller.auth.login')}}">
                                                {{ \App\CPU\translate('seller login')}}
                                            </a>
                                        </div>
                                    </div>
                                </li>
