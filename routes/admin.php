...
//controller // 
    ...
    Route::get('Advertisement/careerSector', [AdvertiseController::class, 'careerSector'])->name('careerSector');
    Route::post('Advertisement/careerSector', [AdvertiseController::class, 'AddCareerSector'])->name('AddCareerSector');
    Route::delete('Advertisement/careerSector', 'AdvertiseController@deleteCareerSector')->name('deleteCareerSector');
    Route::get('Advertisement/careerSector/{id}', [AdvertiseController::class, 'EditCareerSector'])->name('EditCareerSector');
    Route::put('Advertisement/careerSector/{id}', 'AdvertiseController@updateCareerSector')->name('updateCareerSector');


    Route::get('Advertisement/jobTitle', [AdvertiseController::class, 'jobTitle'])->name('jobTitle');
    Route::post('Advertisement/jobTitle', [AdvertiseController::class, 'AddJobTitle'])->name('AddJobTitle');
    Route::delete('Advertisement/jobTitle', 'AdvertiseController@deletejobTitle')->name('deletejobTitle');
    Route::get('Advertisement/jobTitle/{id}', [AdvertiseController::class, 'EditjobTitle'])->name('EditjobTitle');
    Route::put('Advertisement/jobTitle/{id}', 'AdvertiseController@updatejobTitle')->name('updatejobTitle');



    Route::get('Advertisement/advertiseType', [AdvertiseController::class, 'advertiseType'])->name('advertiseType');
    Route::post('Advertisement/advertiseType', [AdvertiseController::class, 'AddAdvertiseType'])->name('AddAdvertiseType');
    Route::delete('Advertisement/advertiseType', 'AdvertiseController@deleteadvertiseType')->name('deleteadvertiseType');
    Route::get('Advertisement/advertiseType/{id}', [AdvertiseController::class, 'EditadvertiseType'])->name('EditadvertiseType');
    Route::put('Advertisement/advertiseType/{id}', 'AdvertiseController@updateadvertiseType')->name('updateadvertiseType');


    Route::get('Advertisement/typeContract', [AdvertiseController::class, 'typeContract'])->name('typeContract');
    Route::post('Advertisement/typeContract', [AdvertiseController::class, 'AddTypeContract'])->name('AddTypeContract');
    Route::delete('Advertisement/typeContract', 'AdvertiseController@deletetypeContract')->name('deletetypeContract');
    Route::get('Advertisement/typeContract/{id}', [AdvertiseController::class, 'EdittypeContract'])->name('EdittypeContract');
    Route::put('Advertisement/typeContract/{id}', 'AdvertiseController@updatetypeContract')->name('updatetypeContract');


    Route::get('Advertisement/workDay', [AdvertiseController::class, 'workDay'])->name('workDay');
    Route::post('Advertisement/workDay', [AdvertiseController::class, 'AddWorkDay'])->name('AddWorkDay');
    Route::delete('Advertisement/workDay', 'AdvertiseController@deleteworkDay')->name('deleteworkDay');
    Route::get('Advertisement/workDay/{id}', [AdvertiseController::class, 'EditworkDay'])->name('EditworkDay');
    Route::put('Advertisement/workDay/{id}', 'AdvertiseController@updateworkDay')->name('updateworkDay');


    Route::get('Advertisement/typeWorkHour', [AdvertiseController::class, 'typeWorkHour'])->name('typeWorkHour');
    Route::post('Advertisement/typeWorkHour', 'AdvertiseController@AddTypeWorkHour')->name('AddTypeWorkHour');
    Route::delete('Advertisement/typeWorkHour', 'AdvertiseController@deletetypeWorkHour')->name('deletetypeWorkHour');
    Route::get('Advertisement/typeWorkHour/{id}', [AdvertiseController::class, 'EdittypeWorkHour'])->name('EdittypeWorkHour');
    Route::put('Advertisement/typeWorkHour/{id}', 'AdvertiseController@updatetypeWorkHour')->name('updatetypeWorkHour');


    Route::get('Advertisement/salary', [AdvertiseController::class, 'salary'])->name('salary');
    Route::post('Advertisement/salary', 'AdvertiseController@Addsalary')->name('Addsalary');
    Route::delete('Advertisement/salary', 'AdvertiseController@deletesalary')->name('deletesalary');
    Route::get('Advertisement/salary/{id}', [AdvertiseController::class, 'Editsalary'])->name('Editsalary');
    Route::put('Advertisement/salary/{id}', 'AdvertiseController@updatesalary')->name('updatesalary');


    Route::get('Advertisement/ExtraBenefit', [AdvertiseController::class, 'ExtraBenefit'])->name('ExtraBenefit');
    Route::post('Advertisement/ExtraBenefit', 'AdvertiseController@AddExtraBenefit')->name('AddExtraBenefit');
    Route::delete('Advertisement/ExtraBenefit', 'AdvertiseController@deleteExtraBenefit')->name('deleteExtraBenefit');
    Route::get('Advertisement/ExtraBenefit/{id}', [AdvertiseController::class, 'EditExtraBenefit'])->name('EditExtraBenefit');
    Route::put('Advertisement/ExtraBenefit/{id}', 'AdvertiseController@updateExtraBenefit')->name('updateExtraBenefit');


    Route::get('Advertisement/EducationDegree', [AdvertiseController::class, 'EducationDegree'])->name('EducationDegree');
    Route::post('Advertisement/EducationDegree', 'AdvertiseController@AddEducationDegree')->name('AddEducationDegree');
    Route::delete('Advertisement/EducationDegree', 'AdvertiseController@deleteEducationDegree')->name('deleteEducationDegree');
    Route::get('Advertisement/EducationDegree/{id}', [AdvertiseController::class, 'EditEducationDegree'])->name('EditEducationDegree');
    Route::put('Advertisement/EducationDegree/{id}', 'AdvertiseController@updateEducationDegree')->name('updateEducationDegree');


    Route::get('Advertisement/Experience', [AdvertiseController::class, 'Experience'])->name('Experience');
    Route::post('Advertisement/Experience', 'AdvertiseController@AddExperience')->name('AddExperience');
    Route::delete('Advertisement/Experience', 'AdvertiseController@deleteExperience')->name('deleteExperience');
    Route::get('Advertisement/Experience/{id}', [AdvertiseController::class, 'EditExperience'])->name('EditExperience');
    Route::put('Advertisement/Experience/{id}', 'AdvertiseController@updateExperience')->name('updateExperience');


    Route::get('Advertisement/License', [AdvertiseController::class, 'License'])->name('License');
    Route::post('Advertisement/License', 'AdvertiseController@AddLicense')->name('AddLicense');
    Route::delete('Advertisement/License', 'AdvertiseController@deleteLicense')->name('deleteLicense');
    Route::get('Advertisement/License/{id}', [AdvertiseController::class, 'EditLicense'])->name('EditLicense');
    Route::put('Advertisement/License/{id}', 'AdvertiseController@updateLicense')->name('updateLicense');


    Route::get('Advertisement/Language', [AdvertiseController::class, 'Language'])->name('Language');
    Route::post('Advertisement/Language', 'AdvertiseController@AddLanguage')->name('AddLanguage');
    Route::delete('Advertisement/Language', 'AdvertiseController@deleteLanguage')->name('deleteLanguage');
    Route::get('Advertisement/Language/{id}', [AdvertiseController::class, 'EditLanguage'])->name('EditLanguage');
    Route::put('Advertisement/Language/{id}', 'AdvertiseController@updateLanguage')->name('updateLanguage');


    Route::get('Advertisement/Nationality', [AdvertiseController::class, 'Nationality'])->name('Nationality');
    Route::post('Advertisement/Nationality', 'AdvertiseController@AddNationality')->name('AddNationality');
    Route::delete('Advertisement/Nationality', 'AdvertiseController@deleteNationality')->name('deleteNationality');
    Route::get('Advertisement/Nationality/{id}', [AdvertiseController::class, 'EditNationality'])->name('EditNationality');
    Route::put('Advertisement/Nationality/{id}', 'AdvertiseController@updateNationality')->name('updateNationality');


    Route::get('Advertisement/Skill', [AdvertiseController::class, 'Skill'])->name('Skill');
    Route::post('Advertisement/Skill', 'AdvertiseController@AddSkill')->name('AddSkill');
    Route::delete('Advertisement/Skill', 'AdvertiseController@deleteSkill')->name('deleteSkill');
    Route::get('Advertisement/Skill/{id}', [AdvertiseController::class, 'EditSkill'])->name('EditSkill');
    Route::put('Advertisement/Skill/{id}', 'AdvertiseController@updateSkill')->name('updateSkill');


    Route::get('Advertisement/CityAdvertis', [AdvertiseController::class, 'CityAdvertis'])->name('CityAdvertis');
    Route::post('Advertisement/CityAdvertis', 'AdvertiseController@AddCityAdvertis')->name('AddCityAdvertis');
    Route::delete('Advertisement/CityAdvertis', 'AdvertiseController@deleteCityAdvertis')->name('deleteCityAdvertis');
    Route::get('Advertisement/CityAdvertis/{id}', [AdvertiseController::class, 'EditCityAdvertis'])->name('EditCityAdvertis');
    Route::put('Advertisement/CityAdvertis/{id}', 'AdvertiseController@updateCityAdvertis')->name('updateCityAdvertis');


    Route::get('Advertisement/stateAdvertis', [AdvertiseController::class, 'stateAdvertis'])->name('stateAdvertis');
    Route::post('Advertisement/stateAdvertis', 'AdvertiseController@AddstateAdvertis')->name('AddstateAdvertis');
    Route::delete('Advertisement/stateAdvertis', 'AdvertiseController@deletestateAdvertis')->name('deletestateAdvertis');
    Route::get('Advertisement/stateAdvertis/{id}', [AdvertiseController::class, 'EditstateAdvertis'])->name('EditstateAdvertis');
    Route::put('Advertisement/stateAdvertis/{id}', 'AdvertiseController@updatestateAdvertis')->name('updatestateAdvertis');


    Route::get('Advertisement/governorate', [AdvertiseController::class, 'governorate'])->name('governorate');
    Route::post('Advertisement/governorate', 'AdvertiseController@Addgovernorate')->name('Addgovernorate');
    Route::delete('Advertisement/governorate', 'AdvertiseController@deletegovernorate')->name('deletegovernorate');
    Route::get('Advertisement/governorate/{id}', [AdvertiseController::class, 'Editgovernorate'])->name('Editgovernorate');
    Route::put('Advertisement/governorate/{id}', 'AdvertiseController@updategovernorate')->name('updategovernorate');



    // for admin
    Route::get('desblayAdvertisement', 'AdvertiseController@desblayAdvertisement')->name('desblayAdvertisement');
    Route::get('desblayAdvertisement/AddAdvertisement', 'AdvertiseController@AddAdvertisement')->name('AddAdvertisement');
    Route::put('desblayAdvertisement/statusForAdmin', 'AdvertiseController@statusAdvertisement')->name('statusAdvertisement');
    Route::get('desblayAdvertisement/fillterForAdmin', 'AdvertiseController@fillterAdvertisement')->name('fillterAdvertisement');

    // for customer
    Route::get('desblayAdvertisementCustomer', 'AdvertiseController@desblayAdvertisementCustomer')->name('desblayAdvertisementCustomer');
    Route::get('desblayAdvertisementCustomer/fillterForCustomer', 'AdvertiseController@fillterAdvertisementCustomer')->name('fillterAdvertisementCustomer');

    // // for seller
    // Route::get('desblayAdvertisementSeller', 'AdvertiseController@desblayAdvertisementCustomer')->name('desblayAdvertisementCustomer');



    Route::get('/selectCareerSector/{id}', 'AdvertiseController@getJobTitle');
    Route::get('/selectStateAdvertis/{id}', 'AdvertiseController@getCityAdvertis');
    Route::get('/selectCityAdvertis/{id}', 'AdvertiseController@getGovernorate');

    Route::post('AddAdvertisement', 'AdvertiseController@storeAdvertisement')->name('storeAdvertisement');
    Route::delete('Advertisement', 'AdvertiseController@deleteAdvertisement')->name('deleteAdvertisement');
    Route::get('Advertisement/Edit/{id}', [AdvertiseController::class, 'EditAdvertisement'])->name('EditAdvertisement');
    Route::put('Advertisement/Edit/{id}', 'AdvertiseController@updateAdvertisement')->name('updateAdvertisement');
    Route::get('delepicture/{id}/{img}',[AdvertiseController::class, 'deletepicture'])->name('deletepicture');

    Route::get('Advertisement/users', [AdvertiseController::class, 'users'])->name('users');
