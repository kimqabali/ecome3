...
Route::group(['namespace' => 'api\v1', 'prefix' => 'v1', 'middleware' => ['api_lang']], function () {
    ...
    Route::group(['prefix' => 'customer', 'middleware' => 'auth:api'], function () {
        ...
        Route::get('MyAdvertisAPI', [App\Http\Controllers\Web\UserProfileController::class, 'MyAdvertisAPI']);
        Route::post('fillterAdvertisement_API', [App\Http\Controllers\Web\UserProfileController::class,
        'fillterAdvertisement_API']);
        Route::get('wishlistsAdvertismentApi', [App\Http\Controllers\Web\UserProfileController::class, 'wishlistsAdvertismentApi']);
        Route::post('deleteWishlistAdvertisApi', [App\Http\Controllers\Web\UserProfileController::class, 'deleteWishlistAdvertisApi']);
        Route::post('deleteMyAd', [App\Http\Controllers\Web\UserProfileController::class, 'deleteMyAd']);
